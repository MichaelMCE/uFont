...
#define FONTFILE		"cjk/wqy-zenhei160.uf"		// default font
#define DETAILFONT		"uf_Latin/helvr24.uf"		// metrics display font
//#define DETAILFONT		"test.uf"					// metrics display font
