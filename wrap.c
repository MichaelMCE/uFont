...
int main (int argc, char **argv)
{
	...
	const uint8_t *str = (const uint8_t*)"Hello World!' sup   ply a 1BPP buffer or pass NULL, one will then be created (alloc'd).again Hello World!' supply a 1BPP buffer or pass NULL, one will then be created (alloc'd).again Hello World!' supply a 1BPP buffer or pass NULL, one will then be created (alloc'd).again- er or pass NULL, one ";
	//uint8_t *str = "HelloWorld!'supplya(1BPP)bufferorpassNULL,onewillthenbecreated(alloc'd).again";
	//uint8_t *str = " ";
